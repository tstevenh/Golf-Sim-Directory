...
export const getCachedNearbyCities = unstable_cache(
  ...
  ["nearby-cities"],
  { revalidate: SIX_MONTHS, tags: ["nearby-cities"] }
);
...
export const getCachedStateVenueCounts = unstable_cache(
  ...
  ["state-venue-counts"],
  { revalidate: SIX_MONTHS, tags: ["state-venue-counts"] }
);
...
export const getCachedCitiesInState = unstable_cache(
  ...
  ["cities-in-state"],
  { revalidate: SIX_MONTHS, tags: ["cities-in-state"] }
);
...
export const getCachedFeaturedVenues = unstable_cache(
  ...
  ["featured-venues"],
  { revalidate: SIX_MONTHS, tags: ["featured-venues"] }
);
...
export const getCachedNearbyVenues = unstable_cache(
  ...
  ["nearby-venues"],
  { revalidate: SIX_MONTHS, tags: ["nearby-venues"] }
);
...
export const getCachedTotalActiveVenueCount = unstable_cache(
  ...
  { revalidate: SIX_MONTHS, tags: ["total-active-venue-count"] }
);
